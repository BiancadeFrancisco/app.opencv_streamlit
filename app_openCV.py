#Necessário instalar scikit-Image no prompt de comando (pip install scikit-Image)
#Biblioteca Open CV: para processamento de imagens
...
def principal():
	...
	filtro_aprimovamento = st.sidebar.checkbox("Melhorar detalhe da Imagem")
